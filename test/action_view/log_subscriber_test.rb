...
class AVLogSubscriberTest < ActiveSupport::TestCase
  ...
  def test_mandatory_fields_present
    ...
    assert_present @log_entry['rendering']
    assert_present @log_entry['rendering'].first['duration']
  end
  ...
  def test_render_file_template
    ...
    assert_equal("test/hello_world.erb", @log_entry['rendering'].first['identifier'])
  end
  ...
  def test_render_text_template
    ...
    assert_equal("text template", @log_entry['rendering'].first['identifier'])
  end
  ...
  def test_render_inline_template
    ...
    assert_equal("inline template", @log_entry['rendering'].first['identifier'])
  end
  ...
  def test_render_partial_template
    ...
    assert_equal("test/_customer.erb", @log_entry['rendering'].first['identifier'])
  end
  ...
  def test_render_partial_with_implicit_path
    ...
    assert_equal("customers/_customer.html.erb", @log_entry['rendering'].first['identifier'])
  end
  ...
  def test_render_collection_template_without_path
    ...
    assert_equal("collection", @log_entry['rendering'].first['identifier'])
  end
